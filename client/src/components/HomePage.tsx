...
import { 
  ...
  IconWifi, IconWifiOff, IconDatabase, IconFileText, IconRefresh
...
export function HomePage() {
  ...
  const pinnedProperties = properties.slice(0, 3);
            ...
            <div className="flex items-center">
              {isUsingMockData ? (
                <>
                  ...
                  <span>Using demo data for property showcase</span>
                </>
              ) : (
                <>
      ...
      {loading && (
        <div className="w-full py-12 text-center">
          ...
          <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 px-4">
            Fetching latest properties from database...
          </p>
        </div>
      )}
          ...
          <div className="w-full max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                ...
                {isUsingMockData && (
                  <span className="block mt-2 text-orange-600 dark:text-orange-400 text-sm">
                    (Demo properties for showcase)
                  </span>
                )}
                {!isUsingMockData && (
